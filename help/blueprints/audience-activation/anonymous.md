...
匿名オーディエンスのアクティベーションは、匿名デバイスや行動データに基づいて、Web、モバイル、広告の各チャネルにわたってオーディエンスに対するターゲティングとパーソナライズをおこなう機能です。
