...
* アカウントジャーニーのMarketo Engage チャネルを通じてアクティベーションが必要な場合、または CRM 同期を使用してアカウントをエンリッチメントする場合 ](https://helpx.adobe.com/legal/product-descriptions/adobe-marketo-engage---product-description.html#performance-guardrails)0}Marketo Engage関連のガードレール } が関連します。[
