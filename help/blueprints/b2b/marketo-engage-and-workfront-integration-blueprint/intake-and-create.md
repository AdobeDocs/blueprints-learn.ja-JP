...
WorkfrontとMarketo Engageを使用すると、システム間の接続により、[Workfront リクエストフォーム &#x200B;](https://experienceleague.adobe.com/docs/workfront/using/administration-and-setup/customize/custom-forms/create-or-edit-a-custom-form.html?lang=ja){target="_blank"} の詳細を使用してMarketo Engage プログラムを作成し、件名、電子メールのコピー、画像、日付、時刻、イベント情報などの主要な変数を入力できます。
...
独自の中核的な拠点（COE）の作成方法について詳しくは、[Marketo Community](https://nation.marketo.com/t5/product-blogs/marketo-master-class-center-of-excellence-with-chelsea-kiko/ba-p/243221){target="_blank"} のベストプラクティスをご覧ください。
