...
>[!TIP]
>このブループリントは、[&#x200B; ユースケースパターン &#x200B;](/help/blueprints/use-case-patterns/b2b/campaign-intake-and-creation.md)としてB2B Activation &amp; Marketingで利用することもできます。
...
![&#x200B; ブループリントの取り込みと作成](assets/intake-and-create-1.png){zoomable="yes"}
...
・ メール コピー<br />
・ Call to action<br />
・ 画像 – AEM AssetsのURLは、Marketoで使用するために直接参照できます<br />
・ オーディエンスの適格基準</td>
  </tr>
  <tr>
   <td>ウェビナー／イベント</td>
...
![&#x200B; トークンを使用してコンテンツ図を入力](assets/intake-and-create-2.png){zoomable="yes"}
