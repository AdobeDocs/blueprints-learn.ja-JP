...
Workfront Fusion を使用すると、マーケティングオペレーションチームは、マーケティング概要をキャンペーンに変換する際に、手動で誤りが生じやすい手順を大幅に排除することができます。 Workfront Fusion は、Workfront と Marketo Engage の間にすぐに使用できる統合レイヤーを提供し、システム間のワークフローを柔軟かつ効率的に開発できるようにします。 統合の設定方法と、ワークフローを自動化するためにどのようなアクションを実行できるかについて詳しくは、[ こちら ](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-fusion/fusion-apps-and-modules/marketo-modules.html?lang=ja){target="_blank"} を参照してください。
...
<table> 
  ...
  <tr> 
   <td>ポートフォリオ</td>
   <td>Workfront のポートフォリオとプログラムを使用して、プロジェクトを整理することができます。 プロジェクトを整理することで、類似するプロジェクトを比較し、リソースが最も役立つ場所を判断できます。<br /><br />
   （例：Portfolioは、サービスや商品の販売に重点を置いた会社内のビジネスユニット用に作成されます）。</td>
  </tr>
  <tr>
   <td>プログラム</td>
   <td>Workfront プログラムを使用して、プロジェクトを整理することができます。 プロジェクトを整理することで、類似するプロジェクトを比較し、リソースが最も役立つ場所を判断できます。<br /><br />
   （例えば、認知度の向上や新製品のローンチ需要の促進など、高いレベルの目標を持つマーケティング戦略。）</td>
  </tr>
  <tr>
   <td>プロジェクト</td>
   <td>Workfront プロジェクトは、特定の目標、成果物、製品などを達成するために完了する必要がある作業項目の集まりです <br /><br />
   （例：電子メールブラスト、育成キャンペーン、ウェビナー、対面イベントなどのマーケティング戦術。 メール、ディスプレイ広告、ランディングページ、ダウンロード可能なホワイトペーパーなど、すべて同じ結果をもたらす複数の戦術を含めることで、1 つのプロジェクトをより複雑にすることもできます。）</td>
  </tr>
  <tr>
   <td>タスク</td>
   <td>Workfront タスクは、プロジェクトまたはイニシアチブの一部となる予定作業項目です。 タスクは、完了するためにユーザーまたはチームに割り当てられます。<br /><br />
   （例えば、オーディエンスセグメントを作成したり、メールのドラフトを作成したりするタスクは、Marketo Engage電子メールプログラムを開発するためのプロジェクトと関連付けられる場合があります。）</td>
  </tr>
  <tr>
   <td>イシュー</td>
   <td>イシューは、Workfront の予定のない作業項目です。 プロジェクト中に発生する問題であったり、リクエストキューを通じて送信されるリクエストであったりします。<br /><br />
   （例：電子メールバナーの画像のサイズが間違っているので問題が発生する。）</td>
  </tr>
  <tr>
   <td>ドキュメント</td>
   <td>Word ドキュメントやプレゼンテーションなど、従来のドキュメントを使用することができます。 また、画像ファイルも使用することができます。 Workfrontでは、ドキュメントや画像に対するコメントや注釈を通じてアセットのプルーフを行い、チーム間のコラボレーションを可能にします。<br /><br />
   （レビューが必要なメールヘッダー画像など）。</td>
  </tr>
  <tr>
   <td>アップデート</td>
   <td>Workfrontでの作業をトラッキングし共同作業を促進するために、コメントと監査ログが含まれます。<br /><br />
...
![Workfront プロジェクトのMarketo Engage プログラムへのマッピング ](assets/overview-4.png){zoomable="yes"}
...
* [レビューして承認](/help/blueprints/b2b/marketo-engage-and-workfront-integration-blueprint/review-and-approve-blueprint.md){target="_blank"}

### Marketo Engage キャンペーン名と関連 URL の管理 {#managing-marketo-engage-campaign-names}

キャンペーンと URL の命名規則の標準化は、Marketo Engage で正確なプログラム管理を行うための重要な基盤であり、キャンペーン開発ライフサイクル全体でプロセスの一貫性を高めるのに役立ちます。 これに役立つツールをお探しの場合は、[Adobe サクセスサービスから無料のオープンソースツールをチェックアウトすることをお勧めします。このツールを使用すると ](https://main--marketo-campaign-tools--dr-adobe.hlx.live/){target="_blank"}Marketo Engage キャンペーンとそれに関連する URL を一貫した方法で作成および管理できます。

### リソース {#resources}

* [Marketo EngageのWorkfront Fusion](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-fusion/fusion-apps-and-modules/marketo-modules.html?lang=ja){target="_blank"}

* [WorkfrontのWorkfront Fusion](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-fusion/fusion-apps-and-modules/workfront-modules.html?lang=ja){target="_blank"}
