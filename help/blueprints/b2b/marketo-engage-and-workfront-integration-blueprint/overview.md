...
![&#x200B; キャンペーンの計画から実行 – オートメーションのユースケース &#x200B;](assets/overview-1.png){zoomable="yes"}
...
![Workfrontにおけるマーケティング施策の表現方法を理解する](assets/overview-2.png){zoomable="yes"}
...
<table> 
  ...
  <tr>
   ...
   （例：オーディエンスセグメントを構築するタスクやメールのドラフトを作成するタスクは、Marketo Engage メールプログラムを開発するプロジェクトに関連付けられているタスクかもしれません）。</td>
  </tr>
  <tr>
   <td>イシュー</td>
   <td>イシューは、Workfront の予定のない作業項目です。 これは、プロジェクト中に発生するイシューか、リクエストキューを介して送信されるリクエストである可能性があります。<br /><br />
   （例：電子メールバナーの画像のディメンションが間違っているため、問題が報告される）</td>
  </tr>
  <tr>
   <td>ドキュメント</td>
...
キャンペーンと URL の命名規則の標準化は、Marketo Engage で正確なプログラム管理を行うための重要な基盤であり、キャンペーン開発ライフサイクル全体でプロセスの一貫性を高めるのに役立ちます。 これを支援するツールをお探しの場合は、[Adobe Success Services](https://main--marketo-campaign-tools--dr-adobe.hlx.live/){target="_blank"}の無料のオープンソースツールを参照することをお勧めします。これにより、Marketo Engage キャンペーンとその関連URLを作成および管理するための一貫したアプローチを構築できます。

### リソース {#resources}

* [Workfront Fusion for Marketo Engage](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-fusion/fusion-apps-and-modules/marketo-modules.html?lang=ja){target="_blank"}
