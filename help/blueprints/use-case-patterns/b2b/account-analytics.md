...
| レポートと分析 | 含まれる | このパターンはそれ自体が分析パターンです。 この機能は、レポート機能と分析機能を提供するコア機能チェーンに組み込まれています。 | [CJAの概要](https://experienceleague.adobe.com/ja/docs/analytics-platform/using/cja-overview/cja-overview) |
