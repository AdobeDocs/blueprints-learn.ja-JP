...
**実行プラン：** オーディエンス評価/宛先設定/ Audience Activation > モニタリング
...
**アプリケーション機能：** RT-CDP: オーディエンス評価、RT-CDP: オーディエンス構成
...
**アプリケーション機能：** RT-CDP: Audience Activation
