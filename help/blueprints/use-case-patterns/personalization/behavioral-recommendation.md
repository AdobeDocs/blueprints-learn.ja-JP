...
| 基本的な能力 | ステータス | 整えておくべきもの | Experience League リファレンス |
| --- | --- | --- | --- |
...
**アプリケーション機能：** AEP: Data Modeling &amp; Preparation （F2）、AEP: Data Sources &amp; Collection （F3）
...
**アプリケーション機能：** RT-CDP: Audience Evaluation、AJO: Campaign Execution、またはJourney Orchestration
...
**アプリケーション機能：** AJO: Reporting &amp; Performance Analysis、S5: Reporting &amp; Analysis
