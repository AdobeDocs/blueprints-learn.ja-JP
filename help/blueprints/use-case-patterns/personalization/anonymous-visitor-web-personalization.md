...
| レポートと分析 | 含まれる | Personalizationのパフォーマンスレポートは、ファンクションチェーン（フェーズ 5）の一部です。 匿名の訪問者のパーソナライゼーションの効果に関するCJA分析を使用すると、AJO ネイティブレポートが提供する内容を超えた、funnelの詳細な分析、コホート比較、コンバージョンの影響測定が可能になります。 | [CJAの概要](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-overview) |
