...
| --- | --- | --- | --- |
| 管理とガバナンス | 同じ位置に仮定 | web チャネル、アプリ内チャネル、決定権限が設定されたAJOサンドボックス。 マーケターとコンテンツ作成者の役割がプロビジョニングされたユーザー。 | [&#x200B; サンドボックスの概要](https://experienceleague.adobe.com/ja/docs/experience-platform/sandbox/home)、[&#x200B; アクセス制御の概要](https://experienceleague.adobe.com/ja/docs/experience-platform/access-control/home) |
