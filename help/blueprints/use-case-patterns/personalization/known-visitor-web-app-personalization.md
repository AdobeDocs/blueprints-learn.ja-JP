...
- [Web SDKでのイベントの追跡](https://experienceleague.adobe.com/en/docs/experience-platform/web-sdk/commands/sendevent/overview)
...
- Edge Network ルックアップの応答時間は、エッジ評価セグメントのSLAが200 ミリ秒未満です。[ リアルタイム顧客プロファイルガードレール ](https://experienceleague.adobe.com/en/docs/experience-platform/profile/guardrails)
- サンドボックスごとに最大4,000個のセグメント定義 – [ セグメント化ガードレール ](https://experienceleague.adobe.com/en/docs/experience-platform/profile/guardrails)
- Edge セグメントは、単純な属性チェックとセグメントメンバーシップクエリ（時系列クエリなし）に限定されます。[Edge セグメント化](https://experienceleague.adobe.com/en/docs/experience-platform/segmentation/methods/edge-segmentation)
- サンドボックスごとにEdgeでアクティブにできる結合ポリシーは1つだけです – [結合ポリシー](https://experienceleague.adobe.com/en/docs/experience-platform/profile/merge-policies/overview)
...
- 1決定あたり最大30件のプレースメント — [Journey Optimizer ガードレール ](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/get-started/guardrails)
