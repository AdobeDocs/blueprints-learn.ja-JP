...
| --- | --- | --- | --- |
| 管理とガバナンス | 所定の位置に想定 | 意思決定権限が有効なAJO サンドボックス。 実装チームに割り当てられたオファー管理の役割（決定マネージャー、オファー承認者）。 | [&#x200B; サンドボックスの概要 &#x200B;](https://experienceleague.adobe.com/ja/docs/experience-platform/sandbox/home)、[&#x200B; アクセス制御の概要 &#x200B;](https://experienceleague.adobe.com/en/docs/experience-platform/access-control/home) |
...
- サンドボックスあたり最大 10,000 件の承認されたパーソナライズされたオファー – [&#x200B; 意思決定管理ガードレール &#x200B;](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/get-started/guardrails)
