...
**実行計画：** Data Connection > Data View Configuration > Workspace Analysis >計算指標の作成> Dashboard Publishing
...
次の表に、このパターンで使用されるCJA アプリケーション機能を示します。
...
次の表に、このパターンで使用されるAEP アプリケーション機能を示します。
...
| 使用したCJA機能 | Connection, Data View, Workspace，計算指標，Dashboard | Connection, Data View, Workspace，計算指標，Dashboard | AまたはBと同様、オーディエンスの公開も可能 | 接続，データビュー，ガイド付き分析，ダッシュボード |
...
**アプリケーション機能：** CJA: Data Connection
...
**アプリケーション機能：** CJA: Workspace Analysis、CJA: Guided Analysis、CJA：計算指標の作成
