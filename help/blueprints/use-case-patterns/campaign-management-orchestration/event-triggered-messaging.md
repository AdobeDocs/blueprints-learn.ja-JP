...
**アプリケーション機能：** AEP: Data Modeling （F2）、AEP: Data Sources &amp; Collection （F3）
...
**アプリケーション機能：** AJO: Journey Orchestration、AJO：頻度とビジネス ルール （オプション C）、AJO：競合と優先度の管理
...
**アプリケーション機能：** AJO: Reporting &amp; Performance Analysis、S4: Monitoring &amp; Observability、S5: Reporting &amp; Analysis
