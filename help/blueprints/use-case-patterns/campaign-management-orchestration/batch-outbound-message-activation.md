...
**アプリケーション機能：** AJO: Campaign Execution （オプション AおよびC）またはAJO: Journey Orchestration（オプション B）
...
- サンドボックスごとに最大4,000個のセグメント定義 – [&#x200B; リアルタイム顧客プロファイルガードレール &#x200B;](https://experienceleague.adobe.com/ja/docs/experience-platform/profile/guardrails)
