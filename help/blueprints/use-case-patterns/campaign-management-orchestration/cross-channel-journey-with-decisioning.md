...
**アプリケーション機能：** [!DNL RT-CDP]: オーディエンス評価
...
**アプリケーション機能：** [!DNL AJO]: Journey Orchestration、[!DNL AJO]：競合と優先度の管理、[!DNL AJO]：頻度とビジネス ルール
...
**アプリケーション機能：** [!DNL AJO]: レポートとパフォーマンス分析
