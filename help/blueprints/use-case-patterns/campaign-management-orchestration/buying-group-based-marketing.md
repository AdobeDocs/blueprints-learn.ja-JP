...
| レポートと分析 | 含まれる | [!DNL AJO B2B Edition]内のB2B分析ダッシュボードは、購買グループのエンゲージメント、アカウントジャーニーのパフォーマンス、パイプラインの指標を提供します。[!DNL CJA B2B Edition] アカウントレベルのワークスペース分析、購買グループ分析、機会相関分析により、分析を拡張。 | [CJAの概要](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-overview) |
