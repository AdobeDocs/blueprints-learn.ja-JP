...
Healthcare Shield は、Real-Time CDP、Customer Journey Analytics、Adobe Journey Optimizerなど、Adobe Experience Platformベースのアプリケーションに対するAdobe Experience Platformのアドオンです。 これらのアプリケーションを HIPAA 対応にし、PHI(Protected Health Information) の処理と使用に関する要件を満たすように設計されています。
...
|-----|-----|
| ストリーミングデータ収集 | <ul><li>Adobe接続と非接続接続の間で使用できる、正規化された柔軟なAdobeモデル<li>B2C マーケティング用に設計された担当者およびアカウントベースのデータスキーマ<li>タグ管理とイベント転送は、イベントレベルのデータをリアルタイムで収集し、配信します。<li> エクスペリエンス配信時間を短縮する最適化されたプロファイル</li></ul> |
| 信頼済みプロファイル管理 | <ul><li>消費者属性、行動、環境設定のデータを含む統合プロファイル<li> データガバナンスフレームワークは、柔軟で透明性が高く、ポリシーの作成と自動実施により、データの誤用を防ぐために、統合プロファイルに適用されます。 </li></ul> |
| リアルタイムアクティベーション | <ul><li>B2C マーケター向けのドラッグ&amp;ドロップによるセグメント化<li>クロスチャネルアクティベーションのためのユーザーレベルおよびアカウントレベルの ID 解決とプロファイルエンリッチメント<li> チャネルと環境 (Adobeと非Adobe) をまたいで、オーディエンスオーケストレーションとリアルタイムでのアクティベーションにより、一貫した顧客体験を提供する </li></ul> |
| 顧客獲得 | <ul><li>未認証ユーザーから認識済み/認証済みユーザーへの変換に対するインサイト<li>未登録ユーザーにメンバーシップの登録を促す。<li> 購読を増やす、または獲得する<li> 顧客プロファイルを分析して傾向を把握する ( 例：. 高価値のセグメントとパフォーマンスの低いセグメントを比較し、獲得を最適化する</li></ul> |
| 顧客エンゲージメント | <ul><li>オファーに対する消費者行動の最新性と頻度アクション（オンラインとオフライン）に基づくオファーのターゲット設定<li>接続されたエクスペリエンスのデジタルプロパティの統合（例：モバイルアプリのダウンロードを促し、チャネル間でセグメントのアクティベーションを使用してエクスペリエンスを接続する）</li></ul> |
| 規模に応じたパーソナライゼーション | <ul><li> 同じページと次のページのパーソナライゼーションをリアルタイムで実行するためのエッジでのセグメント評価<li>ジャーニーをまたいでセッションを放棄した訪問者（例：買い物かごの放棄、コンバージョンに失敗した再訪問者）に一意のターゲット設定されたエクスペリエンスを提供して、エンゲージメントを強化します。<li> オフラインおよびオンラインの行動を統合して結び付け、ユーザーを最適化およびエンゲージメントさせます</li></ul> |
| クロス販売/アップセル | <ul><li>ユーザーとの既存の関係を拡大し、維持しながら顧客を維持<li>クロスビジネスユニット/ブランド/オファーで新しい収益ストリームを顧客のライフタイムバリューに導く<li>製品および SKU 全体の AOV に関するインサイトを得る（頻繁なバンドル、価格の機密性など）</li></ul> |
| 顧客維持/忠誠度 | <ul><li> 消費者のロイヤルティを高め、顧客の離れを防ぐ<li>好みと傾向に基づいて、価値の高い顧客向けにパーソナライズされた製品レコメンデーションをキュレーション<li>エンゲージメントの標準ケイデンスと、常連客向けの特別オファーを作成する<li> オンラインとオフラインの環境設定をリンクし、複数のチャネルにわたるオファーを最適化する</li></ul> |
| Data Collaboration | <ul><li> UI 内で手元で共有を作成し、データコラボレーションワークフローを構築します。<li>( 業界をまたいでファーストパーティのデータが重複している場合、情報に基づいた戦略的なビジネス上の意思決定とキャンペーンを行うことができます。<li>データのサイロを分類し、全体的なカスタマージャーニーを理解する<li> ユースケース別の設定と同意を尊重</li></ul> |
| メディア/マーケティングの効率性と最適化 | <ul><li> 1 つの記録システムで顧客データとアクティベーションチャネルを一元化して管理することで、組織の効率を高めます<li>効果的なメディア支出/効率性の抑制キャンペーンをサポート<li> ガバナンスとポリシーの実施を通じて IT ポリシーに合わせる<li>必要に応じてリアルタイムでデータにアクセスし、タイムリーなキャンペーンをサポート</li></ul> |
...
![ヒッパ準備完了](assets/hippa-ready.png)

**Marketecture 図**

![ヒッパ準備完了](assets/HIPAA-readiness.png)

[Lucidchart のソース](https://lucid.app/lucidchart/8a795213-3bfa-43f3-a542-f0de56123afd/edit?invitationId=inv_d3183739-8c07-4ca2-bfd1-16d819b911a6&amp;page=0_0)
