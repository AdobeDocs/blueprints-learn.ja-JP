...
1. データを Experience Platform に取り込みます。データは、Customer Journey Analytics で処理される前に、Platform に取り込まれる必要があります。データの取り込みとデータソースのタイプについて詳しくは、次のドキュメントを参照してください。 [Analyticsデ](https://experienceleague.adobe.com/docs/experience-platform/sources/home.html?lang=ja) ータコネクタな [どのデータソース](https://experienceleague.adobe.com/docs/experience-platform/sources/connectors/adobe-applications/analytics.html?lang=ja)。[データ取得のチュートリアル](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-D-1-2020.1.dataingestion&amp;lang=ja)
