---
title: Customer Journey Analyticsの設計図
...
# Customer Journey Analyticsの設計図
...
ユースケースとドキュメントの完全なリストについては、[こちら](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-usecases/cja-usecases.html?lang=ja)を参照してください。

## Customer Journey Analytics のアーキテクチャ

![アーキテクチャ図](assets/CJA.png){zoomable="yes"}