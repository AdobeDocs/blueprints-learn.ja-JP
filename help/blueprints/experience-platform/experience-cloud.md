...
description: Experience Cloudのアプリケーション、アプリケーションサービス、Experience Platformが、大規模なマーケティングアーキテクチャにどのように適合するかをご確認ください。
...
これらの図は、Experience Cloudのアプリケーション、アプリケーションサービス、Experience Platformが、エンタープライズマーケティングアーキテクチャにどのように適合するかを示しています。
