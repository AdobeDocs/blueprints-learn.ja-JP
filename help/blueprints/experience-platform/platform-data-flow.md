...
<img src="assets/aep_data_flow.svg" alt="Experience Platform データフロー" style="border:1px solid #4a4a4a" width="90%" />

## データ取り込みガードレール

次の図は、Adobe Experience Platform にデータを取り込む際の平均パフォーマンスのガードレールとレイテンシを示しています。

<img src="assets/aep_data_flow_guardrails.svg" alt="Experience Platform データフロー" style="border:1px solid #4a4a4a" width="90%" />