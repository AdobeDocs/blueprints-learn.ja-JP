---
title: コンバージョン率の向上
description: 購入、サインアップ、フォーム送信などの目的のアクションを完了する訪問者や見込み客の割合を向上させる方法を説明します。
...
購入、サインアップ、フォーム送信などの目的のアクションを完了する訪問者や見込み客の割合を改善します。 この目的は、カスタマージャーニーのすべてのタッチポイントを最適化して、パーソナライズされたエクスペリエンスとタイムリーなメッセージを通じて摩擦を減らし、アクションを促進することに焦点を当てています。
...
| KPI | 説明 |
| --- | --- |
| コンバージョン率 | 目的のアクションを完了した訪問者または見込み客の割合 |
| リードコンバージョン | funnelを通じてコンバージョンに至るリードの割合 |
| リードあたりのコスト | 見込み客を適格なリードに変換するコスト効率 |
