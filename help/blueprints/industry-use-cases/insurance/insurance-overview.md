...
結婚、住宅の購入、家族の成長、退職など、新しいライフステージに入る顧客を特定し、進化する保護ニーズに一致する関連保険商品を提供します。 ライフステージにおけるターゲティングは、保険契約者が適切なカバレッジをタイミングよく構築するのに役立ちます。

### ビジネスへの影響

ライフステージに応じた商品オファーにより、ライフステージの商品の採用率を向上させ、重要な意思決定の瞬間に顧客との関係を深めることができます。

### 導入方法

Decisioning[&#128279;](/help/blueprints/use-case-patterns/campaign-management-orchestration/cross-channel-journey-with-decisioning.md) パターンで クロスチャネルジャーニーを使用します。 ライフステージの移行では、クロスチャネルのオーケストレーションとリアルタイムの意思決定を組み合わせることで、最も関連性の高い製品を選択し、顧客が好むチャネルを最適なタイミングで提供することができます。 これは、複数のチャネルをまたいで配信を調整し、一貫性のあるオファーを提供しながら、検出されたライフステージに最も適した製品を選択する意思決定を活用する必要がある場合に適したパターンです。マルチステップオーケストレーションだけでは、保険製品のレコメンデーションに必要な適格性と適合性の評価をリアルタイムで提供することはできません。

### 技術的な考慮事項

- 住所の変更、受取人の更新、オンライン調査パターンなどの行動シグナルとポリシー変更イベントを組み合わせて、ライフステージの検出モデルを構築します。
- それぞれのライフステージと適切なカバレッジ推奨事項に一致する製品の適格性と適合性ルールを決定エンジンに設定します。
- 割り当てられたエージェントやブローカーとライフステージのオファーを調整し、オファーが配信されたときに、顧客とコンサルタントの会話を行う準備を整えます。
- データガバナンスのラベルを、ライフステージの推論に使用されるサードパーティのデータソースに適用し、データプライバシー規制や公正なマーケティング慣行へのコンプライアンスを確保します。
